...
comments: true
title: Customizing images for containerized VMs (1/3)
pub-date: March 26
pub-year: 2020
---
...
> info "Information"
> The content of this blog post has been divided into a series of three articles: this one, which is the first part, explains how to create a custom-built image using different tools such as _Builder Tool_ and _virt-customize_. The second part, deals with the containerization process of the custom-built image and the procedure to upload and store it into a container image registry. The last article describes the different ways the developers can deploy, modify, adapt and connect to the `VirtualMachineInstance` running in the OKD Kubernetes cluster.
...
- Create custom standardized VM images, also known as golden images. [Customizing images for containerized VMs part 1]({% post_url 2020-03-26-Customizing-images-for-containerized-vms %})
- Containerize and deploy the resulting golden VM images from the corporate registry into the OKD Kubernetes cluster. [Customizing images for containerized VMs part 2]({% post_url 2020-04-02-Customizing-images-for-containerized-vms-part2 %})
- Adapt the deployed VM image to adjust developers and business needs. [Customizing images for containerized VMs part 3]({% post_url 2020-04-09-Customizing-images-for-containerized-vms-part3 %})
...
<div class="my-gallery" itemscope itemtype="http://schema.org/ImageGallery">
  ...
  >
    <a
      href="/assets/2020-03-26-Customizing-images-for-containerized-vms/kubevirt_okd.png"
      itemprop="contentUrl"
      data-size="1110x520"
    >
      <img
        src="/assets/2020-03-26-Customizing-images-for-containerized-vms/kubevirt_okd.png"
        itemprop="thumbnail"
        width="100%"
        alt="VM to VM"
      />
...
<div class="my-gallery" itemscope itemtype="http://schema.org/ImageGallery">
  ...
  >
    <a
      href="/assets/2020-03-26-Customizing-images-for-containerized-vms/diagram-customizing-images.png"
      itemprop="contentUrl"
      data-size="1110x320"
    >
      <img
        src="/assets/2020-03-26-Customizing-images-for-containerized-vms/diagram-customizing-images.png"
        itemprop="thumbnail"
        width="100%"
        alt="VM to VM"
      />
...
<div class="my-gallery" itemscope itemtype="http://schema.org/ImageGallery">
  ...
  >
    <a
      href="/assets/2020-03-26-Customizing-images-for-containerized-vms/cockpit-gui.png"
      itemprop="contentUrl"
      data-size="1110x484"
    >
      <img
        src="/assets/2020-03-26-Customizing-images-for-containerized-vms/cockpit-gui.png"
        itemprop="thumbnail"
        width="100%"
        alt="VM to VM"
      />
...
<div class="my-gallery" itemscope itemtype="http://schema.org/ImageGallery">
  ...
  >
    <a
      href="/assets/2020-03-26-Customizing-images-for-containerized-vms/cockpit-first-page.png"
      itemprop="contentUrl"
      data-size="1110x333"
    >
      <img
        src="/assets/2020-03-26-Customizing-images-for-containerized-vms/cockpit-first-page.png"
        itemprop="thumbnail"
        width="100%"
        alt="VM to VM"
      />
...
<div class="my-gallery" itemscope itemtype="http://schema.org/ImageGallery">
  ...
  >
    <a
      href="/assets/2020-03-26-Customizing-images-for-containerized-vms/create_blueprint.png"
      itemprop="contentUrl"
      data-size="1110x449"
    >
      <img
        src="/assets/2020-03-26-Customizing-images-for-containerized-vms/create_blueprint.png"
        itemprop="thumbnail"
        width="100%"
        alt="VM to VM"
      />
...
<div class="my-gallery" itemscope itemtype="http://schema.org/ImageGallery">
  ...
  >
    <a
      href="/assets/2020-03-26-Customizing-images-for-containerized-vms/users.png"
      itemprop="contentUrl"
      data-size="1110x380"
    >
      <img
        src="/assets/2020-03-26-Customizing-images-for-containerized-vms/users.png"
        itemprop="thumbnail"
        width="100%"
        alt="VM to VM"
      />
...
<div class="my-gallery" itemscope itemtype="http://schema.org/ImageGallery">
  ...
  >
    <a
      href="/assets/2020-03-26-Customizing-images-for-containerized-vms/packages_version.png"
      itemprop="contentUrl"
      data-size="1110x454"
    >
      <img
        src="/assets/2020-03-26-Customizing-images-for-containerized-vms/packages_version.png"
        itemprop="thumbnail"
        width="100%"
        alt="VM to VM"
      />
...
This is the final building configuration file, it can be downloaded from [here](/assets/2020-03-26-Customizing-images-for-containerized-vms/devstation-centos8.toml)
...
In this blog post, it was detailed a real use case of a company that uses KubeVirt to run standardized environments to run and test the code of their applications. In their use case, VMs are spinned up on-demand in the OKD Kubernetes cluster by the developers. This makes them completely autonomous creating and deleting their environments once the tasks are accomplished.

The article explained how to create a golden image using different tools such as _Builder Tool_ and _virt-customize_. Once the custom-built image is ready, then it will be transformed into a container image so that it can be uploaded and stored into a container image registry.

> info "Information"
> In the next blog post [Customizing images for containerized VMs part 2]({% post_url 2020-04-02-Customizing-images-for-containerized-vms-part2 %}) of this series, the custom-built image will be containerized and stored into the corporate registry running in the OKD Kubernetes cluster. It will be shown the process of transforming the newly created QCOW2 image file into a container image that can easily be deployed in our cluster running KubeVirt.
